...
class VideoCapture:
  ...
  def __init__(self, name):
    self.name = name
    self.gst = f"rtspsrc location={self.name} latency=1 drop-on-latency=true ! queue ! rtph264depay ! h264parse ! avdec_h264 ! videoconvert ! appsink max-buffers=1 drop=True"
